...
CREATE EXTERNAL TABLE IF NOT EXISTS hiveAssignment1DynPArt(Col2String1 String,Col3String2 String,Col4String3 String, col5 int, col6 string)
COMMENT 'hive assignment 1'
PARTITIONED BY (StartDate Date)
ROW FORMAT DELIMITED
FIELDS TERMINATED BY '|'
LINES TERMINATED BY '\n'
STORED AS TEXTFILE;
